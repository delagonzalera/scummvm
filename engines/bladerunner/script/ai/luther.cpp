...
bool AIScriptLuther::Update() {
	if ( Actor_Query_Is_In_Current_Set(kActorLuther)
	 ...
	 &&  Global_Variable_Query(kVariableChapter) == 4
		...
		Actor_Says(kActorMcCoy,  5720, 12); // McCoy: Just a moment of your time, please.
		Actor_Says(kActorLuther,   80, 13); // Luther: I am sick and tired of people waving those things around.
		Actor_Says(kActorLance,    40, 12); // Lance: Just give it up. You got no jurisdiction down here.
